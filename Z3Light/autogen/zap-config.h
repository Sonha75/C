...
#define GENERATED_ATTRIBUTES { \
  { 0x0000, ZCL_INT8U_ATTRIBUTE_TYPE, 1, (ATTRIBUTE_MASK_SINGLETON), { (uint8_t*)8  } }, /* 0 Cluster: Basic, Attribute: ZCL version, Side: server*/ \
	  ...
	  { 0xFFFD, ZCL_INT16U_ATTRIBUTE_TYPE, 2, (ATTRIBUTE_MASK_SINGLETON), { (uint8_t*)1  } }, /* 13 Cluster: Basic, Attribute: cluster revision, Side: server*/ \
		  ...
		  { 0x0000, ZCL_BOOLEAN_ATTRIBUTE_TYPE, 1, (ATTRIBUTE_MASK_TOKENIZE), { (uint8_t*)0  } }, /* 24 Cluster: On/off, Attribute: on/off, Side: server*/ \
		  { 0x4000, ZCL_BOOLEAN_ATTRIBUTE_TYPE, 1, (0x00), { (uint8_t*)1  } }, /* 25 Cluster: On/off, Attribute: global scene control, Side: server*/ \
		  { 0x4001, ZCL_INT16U_ATTRIBUTE_TYPE, 2, (ATTRIBUTE_MASK_WRITABLE), { (uint8_t*)0  } }, /* 26 Cluster: On/off, Attribute: on time, Side: server*/ \
		  { 0x4002, ZCL_INT16U_ATTRIBUTE_TYPE, 2, (ATTRIBUTE_MASK_WRITABLE), { (uint8_t*)0  } }, /* 27 Cluster: On/off, Attribute: off wait time, Side: server*/ \
		  { 0x4003, ZCL_ENUM8_ATTRIBUTE_TYPE, 1, (ATTRIBUTE_MASK_WRITABLE| ATTRIBUTE_MASK_TOKENIZE), { (uint8_t*)255  } }, /* 28 Cluster: On/off, Attribute: start up on off, Side: server*/ \
		  { 0xFFFD, ZCL_INT16U_ATTRIBUTE_TYPE, 2, (0x00), { (uint8_t*)1  } }, /* 29 Cluster: On/off, Attribute: cluster revision, Side: server*/ \
		  { 0x0000, ZCL_INT8U_ATTRIBUTE_TYPE, 1, (ATTRIBUTE_MASK_TOKENIZE), { (uint8_t*)0  } }, /* 30 Cluster: Level Control, Attribute: current level, Side: server*/ \
		  ...
		  { 0x0011, ZCL_INT8U_ATTRIBUTE_TYPE, 1, (ATTRIBUTE_MASK_WRITABLE), { (uint8_t*)254  } }, /* 34 Cluster: Level Control, Attribute: on level, Side: server*/ \
		  { 0x0014, ZCL_INT8U_ATTRIBUTE_TYPE, 1, (ATTRIBUTE_MASK_WRITABLE), { (uint8_t*)0  } }, /* 35 Cluster: Level Control, Attribute: default move rate, Side: server*/ \
		  { 0x4000, ZCL_INT8U_ATTRIBUTE_TYPE, 1, (ATTRIBUTE_MASK_WRITABLE| ATTRIBUTE_MASK_TOKENIZE), { (uint8_t*)51  } }, /* 36 Cluster: Level Control, Attribute: start up current level, Side: server*/ \
		  { 0xFFFD, ZCL_INT16U_ATTRIBUTE_TYPE, 2, (0x00), { (uint8_t*)1  } }, /* 37 Cluster: Level Control, Attribute: cluster revision, Side: server*/ \
	  ...
	  { 0xFFFD, ZCL_INT16U_ATTRIBUTE_TYPE, 2, (ATTRIBUTE_MASK_CLIENT), { (uint8_t*)0x0001  } }, /* 49 Cluster: Green Power, Attribute: cluster revision, Side: client*/ \
		  ...
		  { 0xFFFD, ZCL_INT16U_ATTRIBUTE_TYPE, 2, (ATTRIBUTE_MASK_CLIENT), { (uint8_t*)3  } }, /* 90 Cluster: Temperature Measurement, Attribute: cluster revision, Side: client*/ \
		  { 0xFFFD, ZCL_INT16U_ATTRIBUTE_TYPE, 2, (ATTRIBUTE_MASK_CLIENT), { (uint8_t*)2  } }, /* 91 Cluster: Relative Humidity Measurement, Attribute: cluster revision, Side: client*/ \
		  { 0xFFFD, ZCL_INT16U_ATTRIBUTE_TYPE, 2, (ATTRIBUTE_MASK_CLIENT), { (uint8_t*)0x0001  } }, /* 92 Cluster: Occupancy Sensing, Attribute: cluster revision, Side: client*/ \
		  { 0xFFFD, ZCL_INT16U_ATTRIBUTE_TYPE, 2, (0x00), { (uint8_t*)1  } }, /* 93 Cluster: ZLL Commissioning, Attribute: cluster revision, Side: server*/ \
		  { 0xFFFD, ZCL_INT16U_ATTRIBUTE_TYPE, 2, (ATTRIBUTE_MASK_MANUFACTURER_SPECIFIC| ATTRIBUTE_MASK_CLIENT), { (uint8_t*)0x0001  } }, /* 94 Cluster: Height bin, Attribute: cluster revision, Side: client*/ \
		  { 0xFFFD, ZCL_INT16U_ATTRIBUTE_TYPE, 2, (ATTRIBUTE_MASK_MANUFACTURER_SPECIFIC| ATTRIBUTE_MASK_CLIENT), { (uint8_t*)0x0001  } } /* 95 Cluster: Weight bin, Attribute: cluster revision, Side: client*/ \
		 }
...
#define GENERATED_CLUSTERS { \
  { 0x0000, (EmberAfAttributeMetadata*)&(generatedAttributes[0]), 14, 0, CLUSTER_MASK_SERVER, NULL }, /* 0, Endpoint Id: 1, Cluster: Basic, Side: server*/ \
	  ...
	  { 0x0406, (EmberAfAttributeMetadata*)&(generatedAttributes[92]), 1, 2, CLUSTER_MASK_CLIENT, NULL }, /* 7, Endpoint Id: 1, Cluster: Occupancy Sensing, Side: client*/ \
	  { 0x1000, (EmberAfAttributeMetadata*)&(generatedAttributes[93]), 1, 2, CLUSTER_MASK_SERVER, NULL }, /* 8, Endpoint Id: 1, Cluster: ZLL Commissioning, Side: server*/ \
	  ...
	  { 0x0008, (EmberAfAttributeMetadata*)&(generatedAttributes[30]), 8, 11, CLUSTER_MASK_SERVER, NULL }, /* 14, Endpoint Id: 2, Cluster: Level Control, Side: server*/ \
	  ...
	  { 0x1000, (EmberAfAttributeMetadata*)&(generatedAttributes[93]), 1, 2, CLUSTER_MASK_SERVER, NULL }, /* 17, Endpoint Id: 2, Cluster: ZLL Commissioning, Side: server*/ \
	  { 0x0000, (EmberAfAttributeMetadata*)&(generatedAttributes[0]), 14, 0, CLUSTER_MASK_SERVER, NULL }, /* 18, Endpoint Id: 3, Cluster: Basic, Side: server*/ \
	  { 0x0003, (EmberAfAttributeMetadata*)&(generatedAttributes[14]), 2, 4, CLUSTER_MASK_SERVER, NULL }, /* 19, Endpoint Id: 3, Cluster: Identify, Side: server*/ \
	  { 0x0004, (EmberAfAttributeMetadata*)&(generatedAttributes[16]), 2, 3, CLUSTER_MASK_SERVER, NULL }, /* 20, Endpoint Id: 3, Cluster: Groups, Side: server*/ \
	  { 0x0005, (EmberAfAttributeMetadata*)&(generatedAttributes[18]), 6, 8, CLUSTER_MASK_SERVER, NULL }, /* 21, Endpoint Id: 3, Cluster: Scenes, Side: server*/ \
	  { 0x0006, (EmberAfAttributeMetadata*)&(generatedAttributes[24]), 6, 9, CLUSTER_MASK_SERVER, NULL }, /* 22, Endpoint Id: 3, Cluster: On/off, Side: server*/ \
	  { 0x0402, (EmberAfAttributeMetadata*)&(generatedAttributes[90]), 1, 2, CLUSTER_MASK_CLIENT, NULL }, /* 23, Endpoint Id: 3, Cluster: Temperature Measurement, Side: client*/ \
	  { 0x0405, (EmberAfAttributeMetadata*)&(generatedAttributes[91]), 1, 2, CLUSTER_MASK_CLIENT, NULL }, /* 24, Endpoint Id: 3, Cluster: Relative Humidity Measurement, Side: client*/ \
	  { 0xFC01, (EmberAfAttributeMetadata*)&(generatedAttributes[94]), 1, 2, CLUSTER_MASK_CLIENT, NULL }, /* 25, Endpoint Id: 3, Cluster: Height bin, Side: client*/ \
	  { 0xFC02, (EmberAfAttributeMetadata*)&(generatedAttributes[95]), 1, 2, CLUSTER_MASK_CLIENT, NULL }, /* 26, Endpoint Id: 3, Cluster: Weight bin, Side: client*/ \
	  { 0x0021, (EmberAfAttributeMetadata*)&(generatedAttributes[42]), 8, 297, CLUSTER_MASK_CLIENT, NULL } /* 27, Endpoint Id: 242, Cluster: Green Power, Side: client*/ \
	 }
...
#define GENERATED_ENDPOINT_TYPES { \
  { ((EmberAfCluster*)&(generatedClusters[0])), 9, 54 }, \
	  { ((EmberAfCluster*)&(generatedClusters[9])), 9, 118 }, \
	  { ((EmberAfCluster*)&(generatedClusters[18])), 9, 32 }, \
	  { ((EmberAfCluster*)&(generatedClusters[27])), 1, 297 }, \
	 } 
...
#define ZCL_USING_HEIGHT_BIN_CLIENT
#define ZCL_USING_WEIGHT_BIN_CLIENT
...
#define EMBER_AF_HEIGHT_BIN_CLIENT_ENDPOINT_COUNT (1)
#define EMBER_AF_WEIGHT_BIN_CLIENT_ENDPOINT_COUNT (1)
...
#define ZCL_USING_HEIGHT_BIN_CLUSTER_REVISION_CLIENT_ATTRIBUTE
#define ZCL_USING_WEIGHT_BIN_CLUSTER_REVISION_CLIENT_ATTRIBUTE
