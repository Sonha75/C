...
/** @brief Parser function for "Transfer height" ZCL command from "Height bin" cluster
 */
...
/** @brief Parser function for "Transfer weight" ZCL command from "Weight bin" cluster
 */
