...
#define GENERATED_ATTRIBUTES { \
  { 0x0000, ZCL_INT8U_ATTRIBUTE_TYPE, 1, (ATTRIBUTE_MASK_SINGLETON), { (uint8_t*)0x08  } }, /* 0 Cluster: Basic, Attribute: ZCL version, Side: server*/ \
		  ...
		  { 0xFFFD, ZCL_INT16U_ATTRIBUTE_TYPE, 2, (ATTRIBUTE_MASK_CLIENT), { (uint8_t*)3  } }, /* 6 Cluster: Temperature Measurement, Attribute: cluster revision, Side: client*/ \
		  { 0xFFFD, ZCL_INT16U_ATTRIBUTE_TYPE, 2, (ATTRIBUTE_MASK_CLIENT), { (uint8_t*)2  } } /* 7 Cluster: Relative Humidity Measurement, Attribute: cluster revision, Side: client*/ \
		 }
...
#define GENERATED_CLUSTERS { \
  { 0x0000, (EmberAfAttributeMetadata*)&(generatedAttributes[0]), 3, 0, CLUSTER_MASK_SERVER, NULL }, /* 0, Endpoint Id: 1, Cluster: Basic, Side: server*/ \
	  ...
	  { 0x0402, (EmberAfAttributeMetadata*)&(generatedAttributes[6]), 1, 2, CLUSTER_MASK_CLIENT, NULL }, /* 3, Endpoint Id: 1, Cluster: Temperature Measurement, Side: client*/ \
	  { 0x0405, (EmberAfAttributeMetadata*)&(generatedAttributes[7]), 1, 2, CLUSTER_MASK_CLIENT, NULL } /* 4, Endpoint Id: 1, Cluster: Relative Humidity Measurement, Side: client*/ \
	 }
