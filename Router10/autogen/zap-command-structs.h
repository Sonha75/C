...
/** @brief Structure for ZCL command "Transfer height" from "Height bin" 
 */
typedef struct __zcl_height_bin_cluster_transfer_height_command {
  uint8_t argOne;
} sl_zcl_height_bin_cluster_transfer_height_command_t;

#define sl_zcl_height_bin_cluster_transfer_height_command_signature  { \
  1, \
  (ZAP_SIGNATURE_TYPE_POINTER), offsetof(sl_zcl_height_bin_cluster_transfer_height_command_t, argOne), \
}


/** @brief Structure for ZCL command "Transfer weight" from "Weight bin" 
 */
typedef struct __zcl_weight_bin_cluster_transfer_weight_command {
  uint8_t argOne;
} sl_zcl_weight_bin_cluster_transfer_weight_command_t;

#define sl_zcl_weight_bin_cluster_transfer_weight_command_signature  { \
  1, \
  (ZAP_SIGNATURE_TYPE_POINTER), offsetof(sl_zcl_weight_bin_cluster_transfer_weight_command_t, argOne), \
}
