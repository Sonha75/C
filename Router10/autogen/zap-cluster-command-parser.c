...
// Signature for Transfer height command
static const sl_signature_t sig_height_bin_cluster_transfer_height_command = sl_zcl_height_bin_cluster_transfer_height_command_signature;
// Command parser for Transfer height command
EmberAfStatus zcl_decode_height_bin_cluster_transfer_height_command (EmberAfClusterCommand * cmd, sl_zcl_height_bin_cluster_transfer_height_command_t *cmd_struct) {
  // Use signature-decoding mechanism to parse this command.
  return sli_do_decode(cmd, sig_height_bin_cluster_transfer_height_command, (uint8_t*)cmd_struct);
} 


// Signature for Transfer weight command
static const sl_signature_t sig_weight_bin_cluster_transfer_weight_command = sl_zcl_weight_bin_cluster_transfer_weight_command_signature;
// Command parser for Transfer weight command
EmberAfStatus zcl_decode_weight_bin_cluster_transfer_weight_command (EmberAfClusterCommand * cmd, sl_zcl_weight_bin_cluster_transfer_weight_command_t *cmd_struct) {
  // Use signature-decoding mechanism to parse this command.
  return sli_do_decode(cmd, sig_weight_bin_cluster_transfer_weight_command, (uint8_t*)cmd_struct);
} 
