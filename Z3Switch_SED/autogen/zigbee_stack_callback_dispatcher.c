...
sli_zigbee_af_interpan_mac_filter_match_message_callback (filterIndexMatch, messageType, lastHopLqi, lastHopRssi, messageLength, messageContents);
}
#else // !EZSP_HOST
// Mac Filter Match Message
void sli_zigbee_af_mac_filter_match_message(
...
sli_zigbee_af_interpan_mac_filter_match_message_callback(macFilterMatchStruct);
}
#endif // EZSP_HOST
