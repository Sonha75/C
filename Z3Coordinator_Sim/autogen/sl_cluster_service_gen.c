...
extern uint32_t emberAfGreenPowerClusterClientCommandParse(sl_service_opcode_t opcode,
                                                sl_service_function_context_t *context);
extern uint32_t emberAfGreenPowerClusterServerCommandParse(sl_service_opcode_t opcode,
                                                sl_service_function_context_t *context);
...
const sl_service_function_entry_t sli_cluster_service_entries[] = {
  ...
  { SL_SERVICE_FUNCTION_TYPE_ZCL_COMMAND, 0x0021, (NOT_MFG_SPECIFIC | (SL_CLUSTER_SERVICE_SIDE_SERVER << 16)), emberAfGreenPowerClusterServerCommandParse },
