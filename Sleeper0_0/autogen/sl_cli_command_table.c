...
static const sl_cli_command_info_t cli_cmd__force_hyphen_sleep = \
  SL_CLI_COMMAND(sli_zigbee_app_framework_force_sleep_cli_handler,
                 "",
                  "",
                 {SL_CLI_ARG_END, });
...
const sl_cli_command_entry_t sl_cli_default_command_table[] = {
  ...
  { "force-sleep", &cli_cmd__force_hyphen_sleep, false },
