...
#define GENERATED_ATTRIBUTES { \
  { 0x0000, ZCL_INT8U_ATTRIBUTE_TYPE, 1, (ATTRIBUTE_MASK_SINGLETON), { (uint8_t*)8  } }, /* 0 Cluster: Basic, Attribute: ZCL version, Side: server*/ \
		  ...
		  { 0x0000, ZCL_INT8U_ATTRIBUTE_TYPE, 1, (0x00), { (uint8_t*)0x00  } }, /* 15 Cluster: Level Control, Attribute: current level, Side: server*/ \
		  { 0xFFFD, ZCL_INT16U_ATTRIBUTE_TYPE, 2, (0x00), { (uint8_t*)3  } } /* 16 Cluster: Level Control, Attribute: cluster revision, Side: server*/ \
		 }
...
#define GENERATED_CLUSTERS { \
  { 0x0000, (EmberAfAttributeMetadata*)&(generatedAttributes[0]), 3, 0, CLUSTER_MASK_SERVER, NULL }, /* 0, Endpoint Id: 1, Cluster: Basic, Side: server*/ \
	  ...
	  { 0x0008, (EmberAfAttributeMetadata*)&(generatedAttributes[15]), 2, 3, CLUSTER_MASK_SERVER, NULL }, /* 5, Endpoint Id: 1, Cluster: Level Control, Side: server*/ \
	  { 0x0000, (EmberAfAttributeMetadata*)&(generatedAttributes[0]), 3, 0, CLUSTER_MASK_SERVER, NULL } /* 6, Endpoint Id: 2, Cluster: Basic, Side: server*/ \
	 }
...
#define GENERATED_ENDPOINT_TYPES { \
  { ((EmberAfCluster*)&(generatedClusters[0])), 6, 21 }, \
	  { ((EmberAfCluster*)&(generatedClusters[6])), 1, 0 }, \
	 } 
