...
/*chuyen receive_msg thanh chuoi json de truyen (KHONG TRUYEN NODE_NAME) sau do truyen bang sendcommand(json)*/
    ...
    char *json_data()
    {
        ...
        sprintf(json,"{\"full\":%d,\"humid\":%d,\"smell\":%d,\"temp\":%d,\"weight\":%d,\"bat\":%d}",
        (int)(170000-receive_msg.height),(int)receive_msg.humidity,(int)receive_msg.smell,(int)receive_msg.temperature,(int)receive_msg.mass,(int)receive_msg.battery);
        return json;
...
void httpPUT(const char *json)
{
    ...
    if(receive_msg.id ==1 )
    {
        ...
        sendcommand("AT+HTTPPARA=\"URL\",\"https://iot-chale-default-rtdb.asia-southeast1.firebasedatabase.app/trash/trash1/dynamic.json\"");
   ...
   else if(receive_msg.id == 2)
   {
       // Send AT+HTTPINIT
              ...
              // neu node gui du lieu la node01
              // gui du lieu len firebase https://iot-chale-default-rtdb.asia-southeast1.firebasedatabase.app/trash/trash1
              sendcommand("AT+HTTPPARA=\"URL\",\"https://iot-chale-default-rtdb.asia-southeast1.firebasedatabase.app/trash/trash2/dynamic.json\"");
              USTIMER_DelayIntSafe(30000);
   ...
   else if(receive_msg.id == 3)
   {
       // Send AT+HTTPINIT
              ...
              // neu node gui du lieu la node01
              // gui du lieu len firebase https://iot-chale-default-rtdb.asia-southeast1.firebasedatabase.app/trash/trash1
              sendcommand("AT+HTTPPARA=\"URL\",\"https://iot-chale-default-rtdb.asia-southeast1.firebasedatabase.app/trash/trash3/dynamic.json\"");
              USTIMER_DelayIntSafe(30000);
...
//
   ...
   else if(receive_msg.id == 4)
   {
       // Send AT+HTTPINIT
              ...
              // neu node gui du lieu la node01
              // gui du lieu len firebase https://iot-chale-default-rtdb.asia-southeast1.firebasedatabase.app/trash/trash1
              sendcommand("AT+HTTPPARA=\"URL\",\"https://iot-chale-default-rtdb.asia-southeast1.firebasedatabase.app/trash/trash4/dynamic.json\"");
              USTIMER_DelayIntSafe(30000);
