...
#define GENERATED_CLUSTERS { \
  { 0x0000, (EmberAfAttributeMetadata*)&(generatedAttributes[0]), 13, 0, CLUSTER_MASK_SERVER, NULL }, /* 0, Endpoint Id: 1, Cluster: Basic, Side: server*/ \
	  ...
	  { 0x0000, (EmberAfAttributeMetadata*)&(generatedAttributes[0]), 13, 0, CLUSTER_MASK_SERVER, NULL }, /* 7, Endpoint Id: 2, Cluster: Basic, Side: server*/ \
	  { 0x0003, (EmberAfAttributeMetadata*)&(generatedAttributes[14]), 1, 2, CLUSTER_MASK_SERVER, NULL }, /* 8, Endpoint Id: 2, Cluster: Identify, Side: server*/ \
	  { 0x0019, (EmberAfAttributeMetadata*)&(generatedAttributes[20]), 3, 13, CLUSTER_MASK_CLIENT, NULL } /* 9, Endpoint Id: 2, Cluster: Over the Air Bootloading, Side: client*/ \
	 }
...
#define GENERATED_ENDPOINT_TYPES { \
  { ((EmberAfCluster*)&(generatedClusters[0])), 7, 25 }, \
	  { ((EmberAfCluster*)&(generatedClusters[7])), 3, 15 }, \
	 } 
